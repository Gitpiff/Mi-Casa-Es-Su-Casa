...
import { createSpot, getSpot, updateSpot, createSpotImage } from "../../store/spots";
...
const CreateSpotForm = ({spot, formType}) => {
  ...
  }, [address, city, state, description, lat, lng, name, price, country, img1, img2, img3, img4, url])
